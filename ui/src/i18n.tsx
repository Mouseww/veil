...
const STR = {
  en: {
    ...
    helpStart: "Veil hangs a curtain on localhost. Point any app that has a Base URL here, then chat as usual. Secrets leave under an alias; you still see the real text. The model is told to treat aliases as real values and echo them back — never that it cannot see them. Official Claude login needs no extra key.",
  ...
  zh: {
    ...
    running: "代理运行中",
    stopped: "连不上网关",
    helpStart: "Veil 是挂在本机门口的纱帘。任何能改 Base URL 的工具指到这里，然后照常聊。机密化名出门，你看见的还是原文。我们会告诉模型：化名就当真值用，原样写回来，不要说看不见。官方 Claude 登录不用另填 Key。",
