...
const STR = {
  en: {
    ...
    helpRules: "Rules decide what gets replaced with placeholders before a request leaves your machine. Toggle a rule, expand it to edit the regex or dictionary, or add your own. Allowlist values are never replaced.",
  ...
  zh: {
    ...
    helpRules: "规则决定哪些内容在出网前被换成占位符。可以开关、展开编辑正则/词表，或自己加一条。白名单里的值永远不替换。",
