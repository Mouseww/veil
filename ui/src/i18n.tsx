...
const STR = {
  en: {
    ...
    helpStart: "Veil hangs a curtain on localhost. Point any app that has a Base URL here, then chat as usual. Secrets leave under an alias; you still see the real text. Official Claude login needs no extra key.",
  ...
  zh: {
    ...
    running: "代理运行中",
    stopped: "连不上网关",
    helpStart: "Veil 是挂在本机门口的纱帘。任何能改 Base URL 的工具指到这里，然后照常聊。机密化名出门，你看见的还是原文。官方 Claude 登录不用另填 Key。",
